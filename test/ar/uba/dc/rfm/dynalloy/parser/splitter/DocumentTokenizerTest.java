...
//	@Test
//	public void testSpecificBeginnig() throws Exception {
//		DocumentTokenizer tokenizer = new DocumentTokenizer(
//				documentSingleLine(), new Position(1,8));
//		boolean n;
//		DocumentSection token = new DocumentSection();
//		n = tokenizer.next();
//		assertTrue(n);
...
//	@Test
//	public void testNextOfAMoveToAtEndOfTokenGoesToNextToken() throws Exception {
//		DocumentTokenizer tokenizer = new DocumentTokenizer(
//				documentTwoLines());
//		boolean n;
//		DocumentSection token = new DocumentSection();
//		tokenizer.moveTo(new Position(1, 12));
//		n = tokenizer.next(token);
//		assertTrue(n);
//		assertEquals(new Position(2, 1), token.getFrom());
//		assertEquals("asd", token.getText());		

...
public class While_GrammarTest {
	...
	public void while_grammar_test() throws RecognitionException, TokenStreamException, IOException, AssertionNotFound {
		...
		AlloyModule alloyAST = c.compile("test/regr/new_grammar/while_grammar.dals", "test/regr/new_grammar/while_grammar.als", options, 
...
//		System.out.println(alloyStrWithHeader);
		// Write Alloy file
		c.writeFile("test/regr/new_grammar/while_grammar.als", alloyStrWithHeader);
	}

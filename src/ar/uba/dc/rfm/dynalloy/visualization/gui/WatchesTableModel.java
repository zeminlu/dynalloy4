...
import ar.uba.dc.rfm.dynalloy.trace.DynalloyExecutionTraceNull;
import ar.uba.dc.rfm.dynalloy.trace.NameSpace;
...
class WatchesTableModel extends AbstractTableModel {
	...
	private String eval(String expression) {
		...
		DynalloyProgramParseContext ctx = new DynalloyProgramParseContext(
				variables, fields, true);

...
public class DynalloyLexer extends antlr.CharScanner implements DynAlloyANTLRParserTokenTypes, TokenStream
 {
public DynalloyLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public DynalloyLexer(Reader in) {
	this(new CharBuffer(in));
}
public DynalloyLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public DynalloyLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("call", this), new Integer(57));
	literals.put(new ANTLRHashString("pre", this), new Integer(48));
	literals.put(new ANTLRHashString("lblpos", this), new Integer(55));
	literals.put(new ANTLRHashString("open", this), new Integer(43));
	literals.put(new ANTLRHashString("one", this), new Integer(12));
	literals.put(new ANTLRHashString("program", this), new Integer(50));
	literals.put(new ANTLRHashString("action", this), new Integer(46));
	literals.put(new ANTLRHashString("while", this), new Integer(60));
	literals.put(new ANTLRHashString("var", this), new Integer(52));
	literals.put(new ANTLRHashString("lblneg", this), new Integer(54));
	literals.put(new ANTLRHashString("repeat", this), new Integer(62));
	literals.put(new ANTLRHashString("lone", this), new Integer(11));
	literals.put(new ANTLRHashString("assertCorrectness", this), new Integer(53));
	literals.put(new ANTLRHashString("in", this), new Integer(41));
	literals.put(new ANTLRHashString("extends", this), new Integer(40));
	literals.put(new ANTLRHashString("some", this), new Integer(13));
	literals.put(new ANTLRHashString("sig", this), new Integer(39));
	literals.put(new ANTLRHashString("do", this), new Integer(61));
	literals.put(new ANTLRHashString("act", this), new Integer(47));
	literals.put(new ANTLRHashString("as", this), new Integer(44));
	literals.put(new ANTLRHashString("prog", this), new Integer(51));
	literals.put(new ANTLRHashString("assume", this), new Integer(59));
	literals.put(new ANTLRHashString("skip", this), new Integer(64));
	literals.put(new ANTLRHashString("post", this), new Integer(49));
	literals.put(new ANTLRHashString("exactly", this), new Integer(45));
	literals.put(new ANTLRHashString("seq", this), new Integer(14));
	literals.put(new ANTLRHashString("set", this), new Integer(15));
}
...
tryAgain:
	for (;;) {
		...
		try {   // for char stream error handling
			try {   // for lexical error handling
				...
				default:
					if ((LA(1)=='e') && (LA(2)=='l') && (LA(3)=='s') && (LA(4)=='e')) {
						mELSE(true);
						theRetToken=_returnToken;
					}
					else if ((LA(1)=='+') && (LA(2)=='+')) {
	...
	public final void mIF_EXPR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = IF_EXPR;
		int _saveIndex;
	...
	public final void mBACKSLASH_PRE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = BACKSLASH_PRE;
		int _saveIndex;

...
public class QFPreconditionPostfixTransformer extends ExpressionMutator {

	private HashSet<AlloyVariable> varsToPrefix = new HashSet<AlloyVariable>();
	

	
	public QFPreconditionPostfixTransformer(HashSet<AlloyVariable> varsToPrefix){
	...
	public Object visit(ExprVariable ev){	
		...
		for (AlloyVariable av : this.varsToPrefix){
			if (varName.equals(av.getVariableId().getString())){
				AlloyVariable newAV = new AlloyVariable(varName, false);

...
public final class OrFormula extends AlloyFormula {

	private final AlloyFormula left;
	private final AlloyFormula right;

	public OrFormula(AlloyFormula left, AlloyFormula right) {
		super();
		this.left = left;
		this.right = right;
	}
	
	public static AlloyFormula buildOrFormula(AlloyFormula... fs) {
	...
	public boolean equals(Object arg0) {
		if (arg0!=null) {
			if (arg0.getClass().equals(OrFormula.class)) {
				OrFormula of = (OrFormula)arg0;
				return of.getLeft().equals(getLeft()) && of.getRight().equals(getRight());
			}
		}
		return false;
	}

...
public final class ExprProduct extends AlloyExpression {

	private final AlloyExpression left;
	private final AlloyExpression right;

	public ExprProduct(AlloyExpression left, AlloyExpression right) {
		super();
		this.left = left;
		this.right = right;
	}
	...
	public boolean equals(Object obj) {
		if ((obj != null) && (obj.getClass().equals(ExprProduct.class))) {
			ExprProduct eu = (ExprProduct) obj;
